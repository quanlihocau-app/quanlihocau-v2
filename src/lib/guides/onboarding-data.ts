...
export const ONBOARDING_STEPS: GuideStep[] = [
    ...
    },
    {
        ...
        instructions: [
            ...
            "Mục 4 (Giờ vào & Thời gian câu): Mặc định hệ thống tự động chốt giờ ngay khi tạo vé thành công. Nếu khách đã vào chòi câu trước đó hoặc câu ca qua đêm, bấm nút [✏️ Khách vào trước đó] để chọn giờ và ngày vào thực tế, xem ngay Live Preview: Giờ vào, Giờ ra dự kiến, Đã câu và Còn lại/Quá giờ.",
            "Mục 5 & 6: Thêm đồ uống/mồi nếu khách lấy ngay.",
            "Bấm nút to màu xanh lá [Tạo vé và mở ô]. Máy in sẽ tự động in vé giao cho khách với giờ bắt đầu chính xác.",
        ],
        tips: "Nếu khách vào câu từ đêm hôm qua (ví dụ vào lúc 22:30), chọn Ngày vào là hôm qua và Giờ vào 22:30. Bản xem trước sẽ tính toán chính xác giờ ra hôm nay và thời gian đã câu!",
        icon: "ticket",
        practiceUrl: "/sessions/new",
        practiceActionLabel: "🚀 Thực hành Mở vé ngay trên hồ thật",
        realWorldExample: {
            scenario: "Khách anh Hùng đã vào ngồi câu lúc 09:15, đến 10:00 mới ra quầy mở vé Ca 5 tiếng.",
            expectedResult: "Nhân viên chọn Giờ vào 09:15. Hệ thống hiển thị xem trước: Giờ ra 14:15, Đã câu 45 phút, Còn lại 4 giờ 15 phút. Vé in ra ghi nhận giờ bắt đầu chính xác là 09:15.",
        },
        flowSteps: [
            {
                stepNumber: 1,
            ...
            {
                stepNumber: 4,
                title: "Giờ vào & Xem trước thời gian",
                actionDescription: "Mặc định chốt lúc tạo vé. Bấm [Khách vào trước đó] nếu khách đã câu từ trước hoặc ca qua đêm",
                screenLocation: "Mục 4: Giờ vào & Thời gian câu",
                mockupElement: {
                    type: "card",
                    label: "Giờ vào: 09:15 ➔ Ra dự kiến: 14:15",
                    subLabel: "Đã câu: 45 phút • Còn lại: 4 giờ 15 phút",
                    colorClass: "bg-[#F7F9F5] border-[#D5E5D1] text-[#246B38]",
                },
                annotation: "Xem trước giờ ra, thời gian đã trôi qua và cảnh báo nếu vé tạo khi đã quá giờ.",
            },
            {
                stepNumber: 5,
                ...
                annotation: "Vé được tạo tức thì với giờ bắt đầu thực tế, máy in nhả vé và hệ thống chuyển sang Đang câu.",
            },
        ],
    },
    {
